...
function trocaMao_Pc(maoPc) {
    if (maoPc == 1) {
        document.getElementById("escolha__Robo").src = "pedra__robo.png";
    } else if (maoPc == 2) {
        document.getElementById("escolha__Robo").src = "papel__robo.png";
    } else if (maoPc == 3) {
        document.getElementById("escolha__Robo").src = "tesoura__robo.png";
    }
}

function trocaMao_User(maoUs) {
    if (maoUs == 1) {
        document.getElementById("escolha__User").src = "pedra__user.png";
    } else if (maoUs == 2) {
        document.getElementById("escolha__User").src = "papel__user.png";
    } else if (maoUs == 3) {
        document.getElementById("escolha__User").src = "tesoura__user.png";
    }
}
